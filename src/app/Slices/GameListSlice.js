...
export const fetchGameListData = () => async (dispatch) => {
  try {
    ...
    const response = await axios.get(
      import.meta.env.VITE_BASE_URL + "profile/getGameList"
    );
...
export const AddGameListData = (formData) => async () => {
  try {
    const response = await axios.post(
      import.meta.env.VITE_BASE_URL + "profile/addGameList",
      formData,
      {
        headers: {
...
export const deleteGameListData = (game_id) => async (dispatch) => {
  try {
    const response = await axios.delete(
      import.meta.env.VITE_BASE_URL + `profile/deleteGameList/${game_id}`
    );
