...
export const fetchCategoryData = () => async (dispatch) => {
  try {
    ...
    const response = await axios.get(import.meta.env.VITE_BASE_URL + "profile/getAllCategory");
...
export const AddCategoryData = (formData) => async () => {
  try {
    const response = await axios.post(
      import.meta.env.VITE_BASE_URL + "profile/addCategory",
      formData,
      {
        headers: {
...
export const updateCategoryData = (category_id, formData) => async (dispatch) => {
  try {
    const response = await axios.put(
      import.meta.env.VITE_BASE_URL + `profile/updateCategory/${category_id}`,
      formData,
      {
        headers: {
          "Content-Type": "multipart/form-data",
...
export const deleteCategoryData = (category_id) => async (dispatch) => {
  try {
    const response = await axios.delete(
      import.meta.env.VITE_BASE_URL + `profile/deleteCategory/${category_id}`
    );
