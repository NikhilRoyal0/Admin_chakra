...
export const fetchUpiData = () => async (dispatch) => {
  try {
    ...
    const response = await axios.get(
      import.meta.env.VITE_BASE_URL + "accounts/getAllUpiList"
    );
...
export const AddUpiData = (formData) => async (dispatch) => {
  try {
    const response = await axios.post(
      import.meta.env.VITE_BASE_URL + "accounts/addUpi",
      formData,
      {
        headers: {
...
export const updateUpiData = (upi_id, formData) => async (dispatch) => {
  try {
    const response = await axios.put(
      import.meta.env.VITE_BASE_URL + `accounts/updateUpi/${upi_id}`,
      formData,
      {
        headers: {
          "Content-Type": "application/json",
...
export const deleteUpiData = (upi_id) => async (dispatch) => {
  try {
    await axios.delete(
      import.meta.env.VITE_BASE_URL + `accounts/deleteUpi/${upi_id}`
    );
